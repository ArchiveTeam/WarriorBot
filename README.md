...
More information about the archiving project can be found on the ArchiveTeam wiki: [WarriorBot](http://archiveteam.org/index.php?title=WarriorBot)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "WarriorBot" project in the Warrior interface.
...
Package `libzstd-dev` version 1.4.4 is required which is currently available from `buster-backports`.
    ...
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/WarriorBot.git; cd WarriorBot; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/WarriorBot/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, WarriorBot will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/WarriorBot/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
### For Alpine Linux:
    ...
    git clone https://github.com/ArchiveTeam/WarriorBot
    cd WarriorBot; ./get-wget-lua.sh
